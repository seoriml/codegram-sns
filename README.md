...
- 진행 상황을 공유하고, 이를 바탕으로 회의록을 작성했습니다.
...
- 리덕스 툴킷을 사용하여 모달의 열림/닫힘 상태를 전역적으로 관리해 컴포넌트 간의 상태를 일관되게 유지하고, 모달의 내용과 동작을 동적으로 조정
...
- **기술적 및 소통의 어려움**
  - 프로젝트 진행 중 일부 기술적인 부분에서 어려움이 있었고, 이에 따라 팀원 간의 소통이 원활하지 않아 프로젝트가 지연되기도 하였습니다. 이러한 점을 개선하기 위해 앞으로는 초기 단계부터 팀원 간의 소통을 강화하고 기술적 지원을 제공할 필요성이 있음을 깨달았습니다.
